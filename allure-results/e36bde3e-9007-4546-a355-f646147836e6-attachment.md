...
- Name: product/product.spec.js >> TC_PDT_05 Verify product availability
- Location: tests/product/product.spec.js:72:6
...
Call log:
  ...
  - waiting for locator('.availability')
...
```ts
  ...
  71  | 
  72  | test.only('TC_PDT_05 Verify product availability', async ({ page }) => {
  73  | 
