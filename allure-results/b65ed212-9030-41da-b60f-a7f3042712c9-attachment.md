...
- Name: product/product.spec.js >> TC_PDT_06 Verify Add to Cart from PDP
- Location: tests/product/product.spec.js:86:6
...
Call log:
  - waiting for locator('#add-to-cart-button-31')
...
```ts
  ...
  85  | 
  86  | test.only('TC_PDT_06 Verify Add to Cart from PDP', async ({ page }) => {
  87  | 
