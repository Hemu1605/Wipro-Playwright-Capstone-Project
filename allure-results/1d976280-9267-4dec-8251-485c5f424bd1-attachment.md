...
- Location: tests/checkout/checkout.spec.js:174:6
...
Locator: locator('input.button-1.payment-info-next-step-button')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for locator('input.button-1.payment-info-next-step-button')
...
```ts
  ...
  173 | 
  174 | test.only('TC_CHK_07 Verify Payment Information Validation', async ({ page }) => {
  175 | 
  176 |     const checkoutPage = new CheckoutPage(page);
  177 | 
  178 |     // Open checkout page
  179 |     await page.goto(
  180 |         'https://demowebshop.tricentis.com/onepagecheckout'
  181 |     );
  182 | 
  183 |     // Verify payment info button visible
  184 |     await expect(checkoutPage.paymentInfoContinueButton)
> 185 |         .toBeVisible();
      |          ^ Error: expect(locator).toBeVisible() failed
  186 | });
  187 | 
  188 | // TC_CHK_08 → Verify Confirm Order Button
  189 | 
  190 | test('TC_CHK_08 Verify Confirm Order Button', async ({ page }) => {
  191 | 
  192 |     const checkoutPage = new CheckoutPage(page);
  193 | 
  194 |     // Open checkout page
  195 |     await page.goto(
  196 |         'https://demowebshop.tricentis.com/onepagecheckout'
  197 |     );
  198 | 
  199 |     // Verify confirm order button visible
  200 |     await expect(checkoutPage.confirmOrderButton)
  201 |         .toBeVisible();
  202 | });
  203 | 
  204 | // TC_CHK_09 → Verify Order Confirmation Message
  205 | 
  206 | test('TC_CHK_09 Verify Order Confirmation Message', async ({ page }) => {
  207 | 
  208 |     // Open homepage
  209 |     await page.goto(
  210 |         'https://demowebshop.tricentis.com'
  211 |     );
  212 | 
  213 |     // Verify homepage visible
  214 |     await expect(page.locator('body'))
  215 |         .toContainText('Welcome to our store');
  216 | });
  217 | 
  218 | 
  219 | // TC_CHK_10 → Verify Required Field Validation
  220 | 
  221 | test('TC_CHK_10 Verify Required Field Validation', async ({ page }) => {
  222 | 
  223 |     const checkoutPage = new CheckoutPage(page);
  224 | 
  225 |     // Open checkout page
  226 |     await page.goto(
  227 |         'https://demowebshop.tricentis.com/onepagecheckout'
  228 |     );
  229 | 
  230 |     // Verify checkout page visible
  231 |     await expect(page.locator('body'))
  232 |         .toBeVisible();
  233 | });
```