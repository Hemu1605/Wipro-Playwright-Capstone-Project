...
- Name: checkout/checkout.spec.js >> TC_CHK_13 Verify Checkout Total Visibility _addon test cases
...
```ts
  ...
  310 | 
  311 | test('TC_CHK_13 Verify Checkout Total Visibility _addon test cases', async ({ page }) => {
  312 | 
...
> 326 |         .toContainText('Total');
  ...
  330 | 
  331 | test('TC_CHK_14 Verify Async Checkout Loading _addon test cases', async ({ page }) => {
  332 | 
  ...
  357 | 
  358 | test('TC_CHK_15 Verify Checkout API Response _addon test cases', async ({ page }) => {
  359 | 
